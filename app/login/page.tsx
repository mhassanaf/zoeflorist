          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                required
                className="block w-full pl-4 pr-12 py-3 bg-brand-surface border border-brand-neutral-1/40 rounded-xl text-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-accent-soft smooth-transition text-sm"
                placeholder="••••••••"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute inset-y-0 right-0 pr-4 flex items-center text-brand-primary/50 hover:text-brand-accent-bold smooth-transition cursor-pointer"
